...
class Dftb(FileIOCalculator):
    ...
    def read_eigenvalues(self):
        ...
        eig = np.loadtxt(self.lines[index_eig_begin:index_eig_end-1]).flatten()
        #append array
        eig = np.append(eig, np.fromstring(self.lines[index_eig_end-1].split('\n')[0], sep=' ', dtype=float))
        eig *= Hartree
        N = nkpt * nband
